...
public class Game{
  ...
  public static int numberOfRows() {
    ...
    System.out.println("Enter field width");
    int userSelectedRows = scan.nextInt();
  ...
  public static int numberOfColumns() {
    Scanner scan = new Scanner(System.in);
    System.out.println("Enter field height");
    int userSelectedColumns = scan.nextInt();

    return userSelectedColumns;
  }


  public String[][] field = new String[numberOfRows()][numberOfColumns()];   //rows, columns.
  public String[][] display = field; //This is the field that is visible to the player.
  ...
  public void turn(int x, int y){
    if(field[x][y].equals() == true){           //If the spot hasn't been selected, it is cleared.
      isDone = false;
      display[x][y] = empty;
      field[x][y] = empty;
